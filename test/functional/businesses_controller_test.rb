...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { address: @business.address, lat: @business.lat, lon: @business.lon, name: @business.name }
    end
  ...
  test "should update business" do
    put :update, id: @business, business: { address: @business.address, lat: @business.lat, lon: @business.lon, name: @business.name }
    assert_redirected_to business_path(assigns(:business))
  end
